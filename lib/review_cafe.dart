...
class review_cafe extends StatelessWidget {
  final Cafe cafe;

  const review_cafe({Key? key, required this.cafe}) : super(key: key);
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsets.symmetric(horizontal: 14),
                              child: Text(
                                ListReviewCafe[index].description,
                              ),
                            ),
                          ],
                        ),
